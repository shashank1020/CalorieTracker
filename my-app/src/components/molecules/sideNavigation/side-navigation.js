...
import { ContainerOutlined, MenuFoldOutlined, MenuUnfoldOutlined } from '@ant-design/icons';
        ...
        <>
            ...
            >
                <Menu mode='inline' theme='dark'
                      inlineCollapsed={false} style={inlineStyle.container}>
                    ...
                    {location.pathname === '/reports' ? (
                        ...
                        <Menu.Item key='2' icon={<ContainerOutlined />}
                                   onClick={() => setActiveModalId(modalIds.ADD_FOOD)}>
                            Add Meal
                        </Menu.Item>
                    )}
...
const SideNavigationComp = () => {
    ...
    return (
        <>
            ...
            <Button type='primary' className='nav-button' onClick={() => setIsOpen(!isOpen)}
